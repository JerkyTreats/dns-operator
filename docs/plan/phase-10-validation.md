...
Production validation must prove the operator can replace that exact behavior before any broader redesign.
...
- End to end reconciliation across DNS, Tailscale, certificate, and proxy resources.
