...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DNSRecordOwner) DeepCopyInto(out *DNSRecordOwner) {
	*out = *in
	if in.PublishedServiceRef != nil {
		in, out := &in.PublishedServiceRef, &out.PublishedServiceRef
		*out = (*in).DeepCopy()
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DNSRecordOwner.
func (in *DNSRecordOwner) DeepCopy() *DNSRecordOwner {
	if in == nil {
		return nil
	}
	out := new(DNSRecordOwner)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DNSRecordStatus) DeepCopyInto(out *DNSRecordStatus) {
	*out = *in
	if in.RenderedValues != nil {
		in, out := &in.RenderedValues, &out.RenderedValues
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
